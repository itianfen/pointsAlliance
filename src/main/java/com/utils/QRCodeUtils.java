...
public class QRCodeUtils {
    ...
    public static void encode(String content, String imgPath, String destPath, String fileName)
            throws Exception {
        QRCodeUtils.encode(content, imgPath, destPath, false, fileName);
    }
    ...
    public static void encode(String content, String destPath,
                              boolean needCompress, String fileName) throws Exception {
        QRCodeUtils.encode(content, null, destPath, needCompress, fileName);
    }
    ...
    public static void encode(String content, String destPath, String fileName) throws Exception {
        QRCodeUtils.encode(content, null, destPath, false, fileName);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        QRCodeUtils.encode(text, destPath, "123");
    }
}
